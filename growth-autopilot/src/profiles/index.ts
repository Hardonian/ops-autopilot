...
/**
 * JobForge profile - for workflow automation
 */
...
/**
 * Settler profile - for habit tracking
 */
...
/**
 * Readylayer profile - for deployment automation
 */
...
/**
 * AIAS profile - for AI agent systems
 */
...
/**
 * Keys profile - for secrets management
 */
...
export function extendProfile(
  ...
  const extended = {
    ...
    voice: {
      ...base.voice,
      ...overrides.voice,
      vocabulary: { ...base.voice.vocabulary, ...overrides.voice?.vocabulary },
    },
